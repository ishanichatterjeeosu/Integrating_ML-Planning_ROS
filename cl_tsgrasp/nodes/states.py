...
class SpawnNewItem(smach.State):
    ...
    def __init__(self):
        ...
        np.random.seed(2022)
        self.idcs = range(5708,len(self.obj_ds))
        self._cur_item = 0
    ...
    def execute(self, userdata):
        ...
        print(self.idcs[self._cur_item])
        self._cur_item += 1
...
class OpenJaws(smach.State):
    ...
    def execute(self, userdata):
        ...
        success = self.mover.go_gripper(np.array([0.01]))
...
class CloseJaws(smach.State):
    ...
    def execute(self, userdata):
        ...
        success = self.mover.go_gripper(np.array([0.000]))
