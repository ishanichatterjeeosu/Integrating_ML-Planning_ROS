...
void WorkspaceLatticeEGraph::stateToCoord(const std::vector<double>& state, std::vector<int>& coord) const 
{

}
int WorkspaceLatticeEGraph::getOrCreateState(std::vector<int>& coord, const std::vector<double>& state) 
{
    return 0;
}
